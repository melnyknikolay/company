...
<br/>
<br/>
<textarea >Реализация тестового задания:<br/>
...
При удалении компании, ее дочерние компании не удаляются, а полю parrentId присваивается значение 0.<br/>
Данные компании можно редактировать, но поля ID и parrentId скрыты от пользователя.<br/>
Отображение дерева компаний я захардкодил до второго уровня вложености,<br/>
а подсчет доходов - только по первому уровню(родитель + дочерние комп.).<br/>
реализовать по нормальному не хватило времени, т.к. очень хотел успеть до выходных, а днем - на работе.<br/>
<br/>
...
хранятся файлы инициализации и популирования БД.</textarea><br/>
</body>
</html>