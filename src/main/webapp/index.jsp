...
<style text-decoration:line-through>Отображение дерева компаний я захардкодил до второго уровня вложености,
а подсчет доходов - только по первому уровню (родитель + дочерние комп. )
реализовать по нормальному не хватило времени, т к. очень хотел успеть до выходных, а днем - на работе</style><br/>
